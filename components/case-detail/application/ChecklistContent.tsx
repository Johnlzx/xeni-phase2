    ...
    <div className="flex items-center gap-4 py-3 px-4 hover:bg-stone-50 rounded-lg transition-colors">
      ...
      <div className="flex-shrink-0">
        {item.status === "complete" ? (
          ...
          <div className="size-6 rounded-full bg-stone-300 flex items-center justify-center">
            <Lock size={12} className="text-white" />
          </div>
        ) : (
          <div className="size-6 rounded-full border-2 border-stone-300" />
        )}
      </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={`${section.title} section, ${completedItems} of ${totalRequired} completed`}
      >
        ...
        <div className="flex-1 text-left">
          <h3 className="font-semibold text-stone-800 text-balance">
            {section.title}
          </h3>
...
// Main checklist content component
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div>
            <p className="text-sm text-stone-600">
              <span className="font-medium text-stone-800">{completedItems}</span>{" "}
              of{" "}
          ...
          <button
            ...
            aria-label={
              overallProgress >= 100
                ? "Start auto-fill"
                : `Auto-fill disabled, ${totalItems - completedItems} fields remaining`
            }
          >
            <Sparkles size={18} />
            Start Auto-Fill
